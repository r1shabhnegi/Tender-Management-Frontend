...
import VendorCategory from "./VenderDetails/Cards/VendorCategory";
import { useDispatch, useSelector } from "react-redux";
import { RootState } from "@/Redux/store";
import { setActiveVendorDetails } from "@/Redux/vendor/venderDetailsPageSlice";
import VendorInfoEdit from "./VendorInfoEdit";
...
const VendorEdit: FC<Props> = ({ vendorId }) => {
  ...
  return (
    <div className='my-10 mx-auto max-w-[60rem]'>
      ...
      <div className='flex bg-card-color-darker1 flex-col rounded-lg'>
