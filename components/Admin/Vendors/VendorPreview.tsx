    ...
    <div className=''>
      ...
      <div className='px-16 pb-16 grid grid-cols-1 lg:grid-cols-3 gap-8'>
        <div className='lg:col-span-1 '>
          <div className='bg-card-color rounded-2xl shadow-sm p-6 mb-6 sticky top-28'>
            <div className=' flex  flex-col items-center text-center mb-6'>
              <div className='h-24 w-24 rounded-full bg-card-color-darker1 flex items-center justify-center mb-4'>
