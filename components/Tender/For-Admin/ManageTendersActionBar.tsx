...
const ManageTendersActionBar: FC = () => {
  ...
  return (
    <div className='sticky border-b border-accent/10 bg-white  top-[3.8rem] z-[100] py-4 px-2 justify-center flex items-center'>
...
export default ManageTendersActionBar;
